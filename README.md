# otel_AI_Revenue_Manager_Build_Challenge

A Build Solution for the AI Revenue Manager Agent helping the General Managers understand the reservation data and their references using a Natural Language.
...
5. Phase 4 - Building the agent with LangChain and live deployment and evaluation of the AI agent.
6. Phase 5 - Interview (explaining the entire process).
